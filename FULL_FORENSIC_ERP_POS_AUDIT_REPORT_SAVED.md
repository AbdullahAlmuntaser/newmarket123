...
12. [قاعدة البيانات (Database Audit)](#12-قاعدة-الالبيانات)
...
| `lib/presentation/features/accounting/manual_journal_entry_page.dart` | قيد يومية | ✅ مفحوص |
...
- **المشاكل:**
  - ❌ `PurchaseService.postPurchase()` يكرر `TransactionEngine.postPurchase()` - مسارين مختلفان للمشتريات
...
| HI-15 | **decimal → double → decimal** فقدان دقة متسلسل | `production_service.dart`, `budget_service.dart` |
