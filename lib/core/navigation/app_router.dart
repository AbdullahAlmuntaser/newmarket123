...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/sales/invoice/edit/:id', builder: (context, state) => SalesInvoicePage(saleId: state.pathParameters['id'])),
    ...
    GoRoute(path: '/purchases/edit/:id', builder: (context, state) => AddPurchasePage(purchaseId: state.pathParameters['id'])),
